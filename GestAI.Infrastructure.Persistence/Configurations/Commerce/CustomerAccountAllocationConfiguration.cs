...
public sealed class CustomerAccountAllocationConfiguration : IEntityTypeConfiguration<CustomerAccountAllocation>
{
    public void Configure(EntityTypeBuilder<CustomerAccountAllocation> b)
    {
        b.ToTable("CustomerAccountAllocations");
        b.HasKey(x => x.Id);
